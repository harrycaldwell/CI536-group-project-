...
<body>
    ...
    <div class="Course">
        <div class="video-wrapper">
            <div class="videoArea">
                <iframe width="420" height="315" src="https://www.youtube.com/embed/nARrIdmE8BY?si=H19EtjoD2wH41iUj" title="Passwords Video"
        ...
        <section>
            ...
            <p> Passwords are a crucial aspect of our daily lives, whether it's for social media, emails, or sensitive
                tasks like banking. Keeping them safe and secure is paramount. In this section, we'll discuss the risks
            ...
            <p> When usernames and passwords are compromised, it poses significant risks to individuals and
                organizations. For instance, in 2017, Equifax suffered a massive data breach, exposing approximately 147
                million people’s personal data, including phone numbers, addresses, dates of birth, and social security
            ...
            <p> If available, use 2FA as an added layer of security. Even if your password is compromised, access will
                be futile without the 2FA code generated by an app or text. </p>
            <h3>In the Event of Compromise</h3>
            <p> If your password is compromised, change it immediately to prevent further malicious activity. Log out of
                all devices and report the incident to your company's IT department for further assessment and
                containment. </p>
            <h3>Password Manager</h3>
            <p> Using a password manager is a secure way to store and autofill your passwords. Access to the manager can
            ...
            <form id="quiz-form">
                ...
                <div id="question-2" class="question" data-correct-answer="c">
                    ...
                    <div>
                        ...
                        <input type="radio" name="q2" value="c"> c) Reusing the same password for multiple accounts <br>
                ...
                <div id="question-4" class="question" data-correct-answer="c">
                    ...
                    <div>
                        <input type="radio" name="q4" value="a"> a) Ignore it and continue using the same password <br>
                ...
                <div id="question-8" class="question" data-correct-answer="a">
                    ...
                    <div>
                        ...
                        <input type="radio" name="q8" value="b"> b) Share the new password with trusted individuals <br>
